        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2"><?= htmlspecialchars($article['title']) ?></span>
                </div>
            </li>
        </ol>
    </nav>
            ...
            <header class="mb-8">
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm text-gray-600">
                    ...
                    <div class="flex items-center gap-x-2">
                        ...
                        <span><?= htmlspecialchars($article['city']) ?><?= !empty($article['county']) ? ', ' . htmlspecialchars($article['county']) : '' ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </header>
